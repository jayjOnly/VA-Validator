...
PLUGIN_ID = "162502"
PLUGIN_NAME = "Apache Tomcat 8.5.50 < 8.5.82 Vulnerability"
DESCRIPTION = "Apache Tomcat versions from 8.5.50 to 8.5.82 are vulnerable"
...
def check_tomcat_version(hostname: str, port: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if version_match:
            ...
            # Kriteria kerentanan: Tomcat 8.5.50 sampai 8.5.82
            if (major == 8 and minor == 5 and 50 <= patch <= 81):
                is_vulnerable = True
