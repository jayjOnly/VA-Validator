...
PLUGIN_ID = "171656"
PLUGIN_NAME = "Apache Tomcat Path Traversal and RCE Vulnerability (CVE-2023-41080)"
DESCRIPTION = "Apache Tomcat 8.5.0 to 8.5.84 vulnerable to path traversal and potential RCE"
...
def check_tomcat_version(hostname: str, port: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if version_match:
            ...
            # Kriteria kerentanan: Tomcat 8.5.0 sampai 8.5.84
            if (major == 8 and minor == 5 and 0 <= patch <= 84):
                is_vulnerable = True
