...
PLUGIN_ID = "182811"
PLUGIN_NAME = "Apache Tomcat 8.5.0 < 8.5.94 Multiple Vulnerabilities"
DESCRIPTION = "Apache Tomcat versions from 8.5.0 to 8.5.93 are vulnerable to multiple security issues"
...
def check_tomcat_version(hostname: str, port: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if version_match:
            ...
            # Kriteria kerentanan: Tomcat 8.5.0 sampai 8.5.93
            if (major == 8 and minor == 5 and 0 <= patch <= 93):
                is_vulnerable = True
        ...
        result = {
            ...
            "details": f"Apache Tomcat versi {tomcat_version} "
                       ...
                       f"terhadap multiple vulnerabilities",
