...
PLUGIN_ID = "186364"
PLUGIN_NAME = "Apache Tomcat 8.5.0 < 8.5.96 Vulnerability"
DESCRIPTION = "Apache Tomcat versions from 8.5.0 to 8.5.95 are vulnerable"
...
def check_tomcat_version(hostname: str, port: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if version_match:
            ...
            # Kriteria kerentanan: Tomcat 8.5.0 sampai 8.5.95
            if (major == 8 and minor == 5 and 0 <= patch <= 95):
                is_vulnerable = True
        ...
        result = {
            ...
            "details": f"Apache Tomcat versi {tomcat_version} "
                       ...
                       f"terhadap kerentanan versi 8.5.96",
