...
PLUGIN_ID = "192043"
PLUGIN_NAME = "Apache Tomcat 8.5.0 < 8.5.99 Multiple Vulnerabilities"
DESCRIPTION = "Apache Tomcat versions from 8.5.0 to 8.5.98 are vulnerable to multiple security issues"
...
def check_tomcat_version(hostname: str, port: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if version_match:
            ...
            # Kriteria kerentanan: Tomcat 8.5.0 sampai 8.5.98
            if (major == 8 and minor == 5 and 0 <= patch <= 98):
                is_vulnerable = True
