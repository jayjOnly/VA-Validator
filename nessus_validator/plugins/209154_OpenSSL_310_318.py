...
PLUGIN_ID = "209154"
PLUGIN_NAME = "OpenSSL 3.1.0 < 3.1.8 Vulnerability"
DESCRIPTION = "Validasi apakah server menggunakan OpenSSL versi rentan (3.1.0 hingga 3.1.7)"
...
def validate(ip, port):
    ...
    vulnerable_versions = ["3.1.0", "3.1.1", "3.1.2", "3.1.3", "3.1.4", "3.1.5", "3.1.6", "3.1.7"]
